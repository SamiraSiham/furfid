...
import "../../style/tools/select-ville.css";
const SelectVille = () => {
    ...
    return (
        <div className='col-sm-8'>
            <select name="ville" id="" className="select-ville" onChange={handleVille}>
                <option value="" selected disabled>
                    Ville
                </option>
                {villesListe.map((value, i) => (
                    <option key={i} value={value.ville}>{value.ville}</option>
                ))}
            </select>
        </div>
    )
